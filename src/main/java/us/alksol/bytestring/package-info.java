/**
 * Defines a {@link us.alksol.bytestring.Bytes} and other supporting classes in order to represent a safe
 ...
 * 
 * In addition to {@link us.alksol.bytestring.Bytes}, a {@link us.alksol.bytestring.ByteSequence} interface is
